...
export default function SettingsMenu({ isOpen, setIsOpen, setSearchSettings }) {
    ...
    <>
        ...
        <form>
            ...
            <input defaultChecked={check(settings?.engine.Spoonacular, true)} type="radio" id="spoonacularApi" value="spoonacularApi" ref={searchSpoonacularRef} name="engine" />
            ...
            <input defaultChecked={check(settings?.ranking.prioRanking1, true)} type="radio" id="ranking1" value="ranking1" ref={prioRanking1Ref} name="ranking" />
            <label htmlFor="ranking1">Maximize used ingredients</label> <br />
            <input defaultChecked={check(settings?.ranking.prioRanking2, false)} type="radio" id="ranking2" value="ranking2" ref={prioRanking2Ref} name="ranking" />
            ...
            <input defaultChecked={check(settings?.ignorePantry, true)} type="checkbox" id="ignorePantry" value="ignorePantry" ref={ignorePantryRef} name="pantry" />
